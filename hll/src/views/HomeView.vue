<template>
    ...
    <el-container style = "min-height: 100vh">
      <el-aside width="sideWidth + 'px'" style="background-color: rgb(238, 241, 246); box-shadow: 2px 0 6px rgb(0 21 41 / 35%)">
        ...
        :collapse="isCollapse">
          ...
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <template></template>
              <el-menu-item index="1-1">监管人员</el-menu-item>
              <el-menu-item index="1-2">老人家属</el-menu-item>
              <el-menu-item index="1-3">老龄人</el-menu-item>
              <el-menu-item index="1-4">管理员</el-menu-item>
            </el-menu-item-group>
      ...
      <el-container>
        <el-header style = "text-align: left; front-size:12px;border-bottom:1px solid #929494;line-height: 60px ; display: flex">
